                                    ...
                                    <Row className='justify-content-center'>
                                        <Col lg={5}>
                                            <h5 className='mt-0 font-size-18 mb-4'>
                                                <i className='ti-agenda text-primary mr-2'></i>{' '}
                                                General Questions
                                            </h5>
                                            <div
                                                className='accordion'
