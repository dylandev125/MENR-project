                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <div className='row icon-demo-content'>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-500px'></i> fab
                                            fa-500px
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-adn'></i> fab
                                            fa-adn
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-adobe'></i> fab
                                            fa-adobe
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-angry'></i> fas
                                            fa-angry
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-angry'></i> fas
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-apper'></i> fab
                                            fa-apper
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-apple'></i> fab
                                            fa-apple
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-at'></i> fas
                                            fa-at
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-atlas'></i> fas
                                            fa-atlas
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-award'></i> fas
                                            fa-award
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-aws'></i> fab
                                            fa-aws
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-baby'></i> fas
                                            fa-baby
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-bacon'></i> fas
                                            fa-bacon
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-bed'></i> fas
                                            fa-bed
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-beer'></i> fas
                                            fa-beer
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-bell'></i> fas
                                            fa-bell
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-bell'></i> far
                                            fa-bell
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-bible'></i> fas
                                            fa-bible
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-blind'></i> fas
                                            fa-blind
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-blog'></i> fas
                                            fa-blog
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-bold'></i> fas
                                            fa-bold
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-bolt'></i> fas
                                            fa-bolt
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-bomb'></i> fas
                                            fa-bomb
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-bone'></i> fas
                                            fa-bone
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-bong'></i> fas
                                            fa-bong
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-book'></i> fas
                                            fa-book
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-boxes'></i> fas
                                            fa-boxes
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-brain'></i> fas
                                            fa-brain
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-broom'></i> fas
                                            fa-broom
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-brush'></i> fas
                                            fa-brush
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-btc'></i> fab
                                            fa-btc
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-chair'></i> fas
                                            fa-chair
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-check'></i> fas
                                            fa-check
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-chess'></i> fas
                                            fa-chess
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-child'></i> fas
                                            fa-child
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-clock'></i> fas
                                            fa-clock
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-clock'></i> far
                                            fa-clock
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-clone'></i> fas
                                            fa-clone
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-clone'></i> far
                                            fa-clone
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-cloud'></i> fas
                                            fa-cloud
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-cog'></i> fas
                                            fa-cog
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-cogs'></i> fas
                                            fa-cogs
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-coins'></i> fas
                                            fa-coins
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-copy'></i> fas
                                            fa-copy
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-copy'></i> far
                                            fa-copy
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-couch'></i> fas
                                            fa-couch
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-creative-commons-nc-jp'></i>{' '}
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-creative-commons-pd-alt'></i>{' '}
                                            fab fa-creative-commons-pd-alt
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-creative-commons-remix'></i>{' '}
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-cross'></i> fas
                                            fa-cross
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-crow'></i> fas
                                            fa-crow
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-crown'></i> fas
                                            fa-crown
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-cube'></i> fas
                                            fa-cube
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-cubes'></i> fas
                                            fa-cubes
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-cut'></i> fas
                                            fa-cut
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-d-and-d-beyond'></i>{' '}
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-dizzy'></i> fas
                                            fa-dizzy
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-dizzy'></i> fas
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-dolly'></i> fas
                                            fa-dolly
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-draft2digital'></i>{' '}
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-ebay'></i> fab
                                            fa-ebay
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-edge'></i> fab
                                            fa-edge
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-edit'></i> fas
                                            fa-edit
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-edit'></i> far
                                            fa-edit
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-egg'></i> fas
                                            fa-egg
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-egg'></i> fas
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-ello'></i> fab
                                            fa-ello
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-ember'></i> fab
                                            fa-ember
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-eye'></i> fas
                                            fa-eye
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-eye'></i> far
                                            fa-eye
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-fedex'></i> fab
                                            fa-fedex
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-fedora'></i>{' '}
                                            fab fa-fedora
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-figma'></i> fab
                                            fa-figma
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-file'></i> fas
                                            fa-file
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-file'></i> far
                                            fa-file
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-flag'></i> fas
                                            fa-flag
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-flag'></i> far
                                            fa-flag
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-flask'></i> fas
                                            fa-flask
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-flask'></i> fas
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-fonticons-fi'></i>{' '}
                                            fab fa-fonticons-fi
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-frog'></i> fas
                                            fa-frog
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-frown'></i> fas
                                            fa-frown
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-frown'></i> fas
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-gavel'></i> fas
                                            fa-gavel
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-gem'></i> fas
                                            fa-gem
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-gem'></i> far
                                            fa-gem
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-ghost'></i> fas
                                            fa-ghost
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-gift'></i> fas
                                            fa-gift
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-gifts'></i> fas
                                            fa-gifts
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-git'></i> fab
                                            fa-git
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-glide'></i> fab
                                            fa-glide
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-globe'></i> fas
                                            fa-globe
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-grin'></i> fas
                                            fa-grin
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-grin'></i> far
                                            fa-grin
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-grunt'></i> fab
                                            fa-grunt
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-hamsa'></i> fas
                                            fa-hamsa
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-hands'></i> fas
                                            fa-hands
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-haykal'></i>{' '}
                                            fas fa-haykal
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-hdd'></i> fas
                                            fa-hdd
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-heart'></i> fas
                                            fa-heart
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-heart'></i> far
                                            fa-heart
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-hippo'></i> fas
                                            fa-hippo
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-hips'></i> fab
                                            fa-hips
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-home'></i> fas
                                            fa-home
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-hooli'></i> fab
                                            fa-hooli
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-horse'></i> fas
                                            fa-horse
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-hotel'></i> fas
                                            fa-hotel
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-houzz'></i> fab
                                            fa-houzz
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-html5'></i> fab
                                            fa-html5
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-igloo'></i> fas
                                            fa-igloo
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-image'></i> fas
                                            fa-image
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-image'></i> far
                                            fa-image
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-imdb'></i> fab
                                            fa-imdb
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-inbox'></i> fas
                                            fa-inbox
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-java'></i> fab
                                            fa-java
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-jedi'></i> fas
                                            fa-jedi
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-jira'></i> fab
                                            fa-jira
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-joget'></i> fab
                                            fa-joget
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-joint'></i> fas
                                            fa-joint
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-kaaba'></i> fas
                                            fa-kaaba
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-kiss'></i> fas
                                            fa-kiss
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-kiss'></i> far
                                            fa-kiss
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-laugh'></i> fas
                                            fa-laugh
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-laugh'></i> far
                                            fa-laugh
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-lemon'></i> fas
                                            fa-lemon
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-lemon'></i> far
                                            fa-lemon
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-less'></i> fab
                                            fa-less
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-line'></i> fab
                                            fa-line
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-link'></i> fas
                                            fa-link
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-linux'></i> fab
                                            fa-linux
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-magic'></i> fas
                                            fa-magic
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-map'></i> fas
                                            fa-map
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-map'></i> far
                                            fa-map
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-medal'></i> fas
                                            fa-medal
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-medrt'></i> fab
                                            fa-medrt
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-meh'></i> fas
                                            fa-meh
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-meh'></i> far
                                            fa-meh
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-minus'></i> fas
                                            fa-minus
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-moon'></i> fas
                                            fa-moon
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-moon'></i> far
                                            fa-moon
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-music'></i> fas
                                            fa-music
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-npm'></i> fab
                                            fa-npm
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-ns8'></i> fab
                                            fa-ns8
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-opera'></i> fab
                                            fa-opera
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-osi'></i> fab
                                            fa-osi
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-otter'></i> fas
                                            fa-otter
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-page4'></i> fab
                                            fa-page4
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-pager'></i> fas
                                            fa-pager
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-paste'></i> fas
                                            fa-paste
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-pause'></i> fas
                                            fa-pause
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-peace'></i> fas
                                            fa-peace
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-pen'></i> fas
                                            fa-pen
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-phabricator'></i>{' '}
                                            fab fa-phabricator
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-phone'></i> fas
                                            fa-phone
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-pills'></i> fas
                                            fa-pills
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-plane'></i> fas
                                            fa-plane
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-plug'></i> fas
                                            fa-plug
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-plus'></i> fas
                                            fa-plus
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-print'></i> fas
                                            fa-print
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-quora'></i> fab
                                            fa-quora
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-quran'></i> fas
                                            fa-quran
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-react'></i> fab
                                            fa-react
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-rebel'></i> fab
                                            fa-rebel
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-red-river'></i>{' '}
                                            fab fa-red-river
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-reply'></i> fas
                                            fa-reply
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-ring'></i> fas
                                            fa-ring
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-road'></i> fas
                                            fa-road
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-robot'></i> fas
                                            fa-robot
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-rockrms'></i>{' '}
                                            fab fa-rockrms
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-route'></i> fas
                                            fa-route
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-rss'></i> fas
                                            fa-rss
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-ruler'></i> fas
                                            fa-ruler
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-save'></i> fas
                                            fa-save
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-save'></i> far
                                            fa-save
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-schlix'></i>{' '}
                                            fab fa-schlix
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-share'></i> fas
                                            fa-share
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-skull'></i> fas
                                            fa-skull
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-skype'></i> fab
                                            fa-skype
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-slack'></i> fab
                                            fa-slack
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-slash'></i> fas
                                            fa-slash
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-smile'></i> fas
                                            fa-smile
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-smile'></i> far
                                            fa-smile
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-socks'></i> fas
                                            fa-socks
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-speaker-deck'></i>{' '}
                                            fab fa-speaker-deck
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-stamp'></i> fas
                                            fa-stamp
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-star'></i> fas
                                            fa-star
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-star'></i> far
                                            fa-star
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-steam'></i> fab
                                            fa-steam
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-store'></i> fas
                                            fa-store
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-sun'></i> fas
                                            fa-sun
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-sun'></i> far
                                            fa-sun
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-table'></i> fas
                                            fa-table
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-tag'></i> fas
                                            fa-tag
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-tags'></i> fas
                                            fa-tags
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-tape'></i> fas
                                            fa-tape
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-tasks'></i> fas
                                            fa-tasks
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-taxi'></i> fas
                                            fa-taxi
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-teeth'></i> fas
                                            fa-teeth
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-tenge'></i> fas
                                            fa-tenge
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-the-red-yeti'></i>{' '}
                                            fab fa-the-red-yeti
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-times'></i> fas
                                            fa-times
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-tired'></i> fas
                                            fa-tired
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-tired'></i> far
                                            fa-tired
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-tools'></i> fas
                                            fa-tools
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-tooth'></i> fas
                                            fa-tooth
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-torah'></i> fas
                                            fa-torah
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-train'></i> fas
                                            fa-train
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-tram'></i> fas
                                            fa-tram
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-trash'></i> fas
                                            fa-trash
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-truck'></i> fas
                                            fa-truck
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-typo3'></i> fab
                                            fa-typo3
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-uber'></i> fab
                                            fa-uber
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-uikit'></i> fab
                                            fa-uikit
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-uniregistry'></i>{' '}
                                            fab fa-uniregistry
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-ups'></i> fab
                                            fa-ups
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-usb'></i> fab
                                            fa-usb
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-user'></i> fas
                                            fa-user
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='far fa-user'></i> far
                                            fa-user
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-users'></i> fas
                                            fa-users
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-usps'></i> fab
                                            fa-usps
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-ussunnah'></i>{' '}
                                            fab fa-ussunnah
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-venus'></i> fas
                                            fa-venus
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-vial'></i> fas
                                            fa-vial
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-vials'></i> fas
                                            fa-vials
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-viber'></i> fab
                                            fa-viber
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-video'></i> fas
                                            fa-video
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-vimeo'></i> fab
                                            fa-vimeo
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-vine'></i> fab
                                            fa-vine
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-vk'></i> fab
                                            fa-vk
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-vnv'></i> fab
                                            fa-vnv
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-vuejs'></i> fab
                                            fa-vuejs
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-water'></i> fas
                                            fa-water
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-weibo'></i> fab
                                            fa-weibo
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-whmcs'></i> fab
                                            fa-whmcs
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-wifi'></i> fas
                                            fa-wifi
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fas fa-x-ray'></i> fas
                                            fa-x-ray
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-xbox'></i> fab
                                            fa-xbox
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-xing'></i> fab
                                            fa-xing
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-yahoo'></i> fab
                                            fa-yahoo
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-yammer'></i>{' '}
                                            fab fa-yammer
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-yarn'></i> fab
                                            fa-yarn
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-yelp'></i> fab
                                            fa-yelp
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-yoast'></i> fab
                                            fa-yoast
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <i className='fab fa-zhihu'></i> fab
                                            fa-zhihu
                                        </Col>
                                    </div>
                                </CardBody>
