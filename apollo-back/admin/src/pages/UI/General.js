                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    <div className='row'>
                                        ...
                                        <div className='col-lg-6'>
                                            <div>
                                                <h4 className='card-title mo-mt-2'>
                                                    Pill badges
                                                </h4>
                                                <p className='card-title-desc'>
                                                    Use the{' '}
                                                    <code>.badge-pill</code>{' '}
                                                    modifier className to make
                                                    badges more rounded (with a
                                                    larger{' '}
                        ...
                        <div className='col-lg-6'>
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        Add small overlay content, like those
                                        found in iOS, to any element for housing
                        ...
                        <div className='col-lg-6'>
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        Hover over the links below to see
                                        tooltips:
                                    </p>
                                ...
                                <div className='card-body'>
                                    ...
                                    <div className='row'>
                                        <div className='col-lg-6'>
                                            ...
                                            <p className='card-title-desc'>
                                                Pagination links indicate a
                                                series of related content exists
                                        ...
                                        <div className='col-lg-6'>
                                            ...
                                            <p className='card-title-desc'>
                                                ...
                                                circumstances. Use{' '}
                                                <code>.disabled</code> for links
                                                that appear un-clickable and{' '}
                                                <code>.active</code> to indicate
                                                the current page.
                                            </p>
