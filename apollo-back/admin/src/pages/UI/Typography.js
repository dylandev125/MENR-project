                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        , meaning you will need to add the
                                        className for any nested lists as well.
                                    </p>
                        ...
                        <div className='col-lg-6'>
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        Traditional heading elements are
                                        designed to work best in the meat of
                                        your page content.{' '}
                                    </p>
                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        with a combination of two classNamees,{' '}
                                        <code className='highlighter-rouge'>
                                            .list-inline
                                        </code>{' '}
                                        and
                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        horizontally by using our grid system’s
                                        predefined classNamees (or semantic
                                        mixins). For longer terms, you can
                                        optionally add a{' '}
                                        <code className='highlighter-rouge'>
                                            .text-truncate
                                        </code>{' '}
                                        className to truncate the text with an
                                        ellipsis.
                                    </p>
