                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        with some markup changes. Here’s how you
                                        can put them to work with either{' '}
                                        <code className='highlighter-rouge'>
                                            &lt;button&gt;
                                        </code>
                                        elements:
                        ...
                        <div className='col-lg-6'>
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        The best part is you can do this with
                                        any button variant, too:
                                    </p>
                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        all sizes, including default and split
                                        dropdown buttons.
                                    </p>
                                    <div className='btn-group mb-2'>
                                        <ButtonDropdown
                                    ...
                                    <div className='btn-group mb-2'>
                                        <ButtonDropdown
                                            ...
                                            toggle={() =>
                                                this.setState({
                                                    drp_secondary_lg: !this
                                                        .state.drp_secondary_lg,
                                                })
                                            }
                                        >
                                    ...
                                    <div className='btn-group mb-2'>
                                        <ButtonDropdown
                                            ...
                                            toggle={() =>
                                                this.setState({
                                                    drp_secondary_sm: !this
                                                        .state.drp_secondary_sm,
                                                })
                                            }
                                        >
                                            <DropdownToggle
                                    ...
                                    <div className='btn-group mb-2'>
                                        <ButtonDropdown
                                            isOpen={
                                                this.state.drp_secondary_sm1
                                            }
                                            toggle={() =>
                                                this.setState({
                                                    drp_secondary_sm1: !this
                                                        .state
                                                        .drp_secondary_sm1,
                                                })
                                            }
                        ...
                        <div className='col-lg-6'>
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        Trigger dropdown menus at the right of
                                        the elements by adding{' '}
                                        <code>direction = "right" </code> to the
                                        parent element.
                                    </p>
                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        Trigger dropdown menus at the right of
                                        the elements by adding{' '}
                                        <code>direction = "left" </code> to the
                                        parent element.
                                    </p>
