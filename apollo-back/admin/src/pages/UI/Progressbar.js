                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        HTML elements, some CSS to set the
                        ...
                        <div className='col-lg-6'>
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        Use background utility classNamees to
                        ...
                        <div className='col-lg-6'>
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        Include multiple progress bars in a
                                        progress component if you need.
                                    </p>
                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        to apply a stripe via CSS gradient over
