                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        Use the tab JavaScript plugin—include it
                                        individually or through the compiled{' '}
                                        <code className='highlighter-rouge'>
                                            bootstrap.js
                                        </code>
                                        file—to extend our navigational tabs and
                                        pills to create tabbable panes of local
                                            ...
                                            <Row>
                                                <Col sm='12'>
                                                    <CardText>
                                                        ...
                                                        retro keffiyeh
                                                        dreamcatcher synth.
                                                        Cosby sweater eu banh
                                                        mi, qui irure terry
                                                        richardson ex squid.
                                                        Aliquip placeat salvia
                                                        cillum iphone. Seitan
                                                        aliquip quis cardigan
                                                        american apparel,
                                                        butcher voluptate nisi
                                                        qui.
                                                    </CardText>
                                                </Col>
                                            </Row>
                                            ...
                                            <Row>
                                                <Col sm='12'>
                                                    <CardText>
                                                        ...
                                                        aliquip jean shorts
                                                        ullamco ad vinyl cillum
                                                        PBR. Homo nostrud
                                                        organic, assumenda
                                                        labore aesthetic magna
                                                        delectus mollit. Keytar
                                                        helvetica VHS salvia yr,
                                                        vero magna velit
                                                        sapiente labore
                                                        stumptown. Vegan fanny
                                                        pack odio cillum wes
                                                        anderson 8-bit.
                                                    </CardText>
                                                </Col>
                                            </Row>
