                            ...
                            <Row className='text-center'>
                                ...
                                <Col xl='3' lg='4' sm='6' className='m-b-30'>
                                    ...
                                    {this.state.img_html ? (
                                        ...
                                        >
                                            You can use <b>bold</b> text, links
                                            and other HTML tags
                                        </SweetAlert>
                                    ) : null}
                                </Col>
                                ...
                                <Col xl='3' lg='4' sm='6' className='m-b-30'>
                                    ...
                                    {this.state.final_step ? (
                                        ...
                                        >
                                            Your answers : [
                                            {this.state.step1_txt},{' '}
                                            {this.state.step2_txt},{' '}
                                            {this.state.step3_txt}]
                                        </SweetAlert>
                                    ) : null}
                                </Col>
                                ...
                                <Col xl='3' lg='4' sm='6' className='m-b-30'>
                                    ...
                                    {this.state.step_queue ? (
                                        ...
                                        >
                                            Your public IP will be received via
                                            AJAX request
                                        </SweetAlert>
                                    ) : null}
