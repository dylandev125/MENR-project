                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        dialog prompts powered by JavaScript.
                                        They support a number of use cases from
                                        user notification to completely custom
                                    ...
                                    <div className='row'>
                                        <div className='col-sm-6 col-md-3 mt-4'>
                                            ...
                                            >
                                                ...
                                                <div className='modal-body'>
                                                    <h5>
                                                        Overflowing text to show
                                                        scroll behavior
                                                    </h5>
                                                    <p>
                                                        Cras mattis consectetur
                                                        purus sit amet
                                                        fermentum. Cras justo
                                                        odio, dapibus ac
