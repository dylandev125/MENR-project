                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        button. For proper styling, for Example,{' '}
                                        <strong>color = </strong>{' '}
                                    ...
                                    <div className=''>
                                        ...
                                        <Alert color='info'>
                                            ...
                                            alert needs your attention, but it's
                                            not super important.
                                        </Alert>

                                        <Alert color='warning'>
                                            <strong>Warning!</strong> Better
                                            check yourself, you're not looking
                                            too good.
                                        </Alert>

                                        <Alert color='danger' className='mb-0'>
                                            <strong>Oh snap!</strong> Change a
                                            few things up and try submitting
                                            again.
                                        </Alert>
                                    </div>
                                </CardBody>
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        utility className to quickly provide
                        ...
                        <Col lg={6}>
                            <Card>
                                <CardBody>
                                    ...
                                    <p className='card-title-desc'>
                                        You can see this in action with a live
                                        demo:
                                    </p>
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        with different class as background.
                                    </p>
