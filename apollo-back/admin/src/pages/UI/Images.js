                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        are applied to the image so that it
                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        object (images, video, audio) to the
                                    ...
                                    <div className='media'>
                                        <div className='media-body'>
                                            <h5 className='mt-0 mb-1 font-16'>
                                                Media object
                                            </h5>
                                            Cras sit amet nibh libero, in
                                            gravida nulla. Nulla vel metus
                        ...
                        <div className='col-12'>
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <p className='card-title-desc'>
                                        The images or other media can be aligned
                                        top, middle, or bottom. The default is
                                        top aligned.
                                    </p>
                                    ...
                                    <div className='media mb-4'>
                                        ...
                                        <div className='media-body'>
                                            ...
                                            <p>
                                                ...
                                                vulputate at, tempus viverra
                                                turpis. Fusce condimentum nunc
                                                ac nisi vulputate fringilla.
                                                Donec lacinia congue felis in
                                                faucibus.
                                            </p>
                                            <p className='mb-0'>
                                                Donec sed odio dui. Nullam quis
