                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <p className='card-title-desc'>
                                        Reactstarp includes six predefined
                                        button styles, each serving its own
                                        semantic purpose.
                                    </p>
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        styles can be applied to other elements,
                                        such as{' '}
                                        <code className='highlighter-rouge'>
                                            &lt;label&gt;
                                        </code>
                                        s, to provide checkbox or radio style
                                        button toggling. Add{' '}
                                        <code className='highlighter-rouge'>
                                            data-toggle="buttons"
                                        </code>{' '}
                                        ...
                                        containing those modified buttons to
                                        enable toggling in their respective
                                        styles.
                                    </p>
                                    <div
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        needed to space out groups, buttons, and
                                        more.
                                    </p>
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <p className='card-title-desc'>
                                        ...
                                        stacked rather than horizontally. Split
