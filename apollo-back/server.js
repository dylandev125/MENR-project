...
cron.schedule('0 0 * * *', async () => {
	await axios
		.get('https://www.distec.de/rest/products?lang=en&limit=300', config)
		.then(async (res) => {
...
cron.schedule('0 0 * * *', async () => {
	await axios
		.get(
			'https://www.distec.de/rest/products?lang=en&limit=300&offset=300',
			config
		)
		.then(async (res) => {
			for (var i = 0; i < res.data.data.length; i++) {
...
cron.schedule('0 0 * * *', async () => {
	await axios
		.get(
			'https://www.distec.de/rest/products?lang=en&limit=300&offset=600',
			config
		)
		.then(async (res) => {
			for (var i = 0; i < res.data.data.length; i++) {
...
cron.schedule('0 0 * * *', async () => {
	await axios
		.get(
			'https://www.distec.de/rest/products?lang=en&limit=300&offset=900',
			config
		)
		.then(async (res) => {
			for (var i = 0; i < res.data.data.length; i++) {
...
cron.schedule('0 0 1 * *', async () => {
	await axios
		.get('https://www.distec.de/rest/products_folders?lang=en', config)
		.then(async (res) => {
			for (var i = 0; i < res.data.data.length; i++) {
...
cron.schedule('0 0 1 * *', async () => {
	await axios
		.get('https://www.distec.de/rest/products_series?lang=en', config)
		.then(async (res) => {
			for (var i = 0; i < res.data.data.length; i++) {
	...
	await axios
		...
		.then((res) => {
			...
			folders.forEach(async (el) => {
				await axios
					.get(
						`https://www.distec.de/rest/products_categories?lang=en&folders=${el.id}`,
						config
					)
					.then(async (res) => {
						for (var i = 0; i < res.data.data.length; i++) {
...
cron.schedule('0 0 1,16 * *', async () => {
	await axios
		.get('https://www.distec.de/rest/news?lang=en', config)
		.then(async (res) => {
			for (var i = 0; i < res.data.data.length; i++) {
