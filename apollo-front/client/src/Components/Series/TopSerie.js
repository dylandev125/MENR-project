...
const TopFolder = ({ title, content, subtitle, featuredimg }) => {
	useEffect(() => {
		function paralAb() {
			...
			<section>
				<Grid container spacing={4} alignItems='center'>
					<Grid
						...
						xs={12}
						sm={11}
						md={featuredimg !== 'uploads/big-placeholder.jpg' ? 7 : 10}
					>
						<div className='content-boxed'>
							...
							<div
								...
								dangerouslySetInnerHTML={{
									__html: content && content.replace(/Distec/gi, 'Apollo'),
								}}
							></div>
						</div>
					</Grid>
